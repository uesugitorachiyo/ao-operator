...
> **Repository:** `ao-operator`, with public copy using the AO Operator name.
...
v0.6 prepares `ao-operator` for its first public OSS launch as AO Operator:
...
| P3 | Operator release/security/live artifacts moved out of public repo. | private overlay checkout, `74e19308`, `294c0149` |
...
| R2 | Release notes for v0.6 added. | `run-artifacts/release-v0.6/RELEASE-NOTES.md`, `a3631c8c` |
| R3 | Clean-clone verification completed for the v0.6 candidate. | `run-artifacts/release-v0.6/RELEASE-NOTES.md` |
| R6 | v0.6.0 annotated tag created. | `v0.6.0` -> `eb58482a` |
| R7 | Post-`v0.6.0` docs folded into a follow-up release candidate after AO Runtime WAL/native-deploy coverage finished. | `run-artifacts/release-v0.6.1/RELEASE-NOTES.md` |
...
| V5 | Release notes summarize changes, verification, and known operator actions. | `run-artifacts/release-v0.6/RELEASE-NOTES.md` |
